...
public class AddMovieDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Add Movie Details");
        ...
        MovieId.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(26, 26, 26)
                        .addComponent(MovieId, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(163, 163, 163)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Integer MovieID = Integer.valueOf(movieId);
        ...
        if(movieName.isEmpty() || director.isEmpty() || castName.isEmpty() || details.isEmpty() || rating.isEmpty() || movieId.isEmpty() ){
            ...
            try {
                ...
                String sql = "Insert into MOVIE"
                    +"(MovieId,MovieName,Director,CastName,Details,Rating,Picture)"
                    +"values(?,?,?,?,?,?,?)";
                PreparedStatement pst = connection.prepareStatement(sql);
                pst.setInt(1, MovieID);
                pst.setString(2, movieName);
                pst.setString(3, director);
                pst.setString(4, castName);
                pst.setString(5, details);
                pst.setString(6, rating);
                pst.setBytes(7, movie_poster);
